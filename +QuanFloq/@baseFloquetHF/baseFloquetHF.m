classdef (Abstract) baseFloquetHF < QuanFloq.baseFloquet
    ...
    properties
        ...
        % See also QuanFloq.baseFloquetHF.hUk_max2, QuanFloq.baseFloquetHF.hUk_range
    ...
    properties (Dependent,SetAccess=private)
        ...
        % See also QuanFloq.baseFloquetHF.Ne, QuanFloq.baseFloquetHF.mode
        NOrbitals
        % hUk_range - Helper property for [-hUk_max:hUk_max]
        % See also QuanFloq.baseFloquetHF.hUk_max
        hUk_range
        ...
        % See also QuanFloq.baseFloquetHF.get_hUt
        hUt
    end
    ...
    methods
        function obj = baseFloquetHF(N,Args,Args2)
            ...
            % See QuanFloq.baseFloquet.baseFloquet for usage
            %
            ...
            % 
            % See also baseFloquetHF, QuanFloq.baseFloquet.baseFloquet
    ...
    methods
        ...
        function HBar(varargin)
            ...
            %
            % See also QuanFloq.baseFloquetHF.H, baseFloquetHF.Ebar
    ...
    methods
        ...
        function Psi_Slat = OrbitalToSlater(obj,Psi_Orb,Args)
            arguments
                ...
                Psi_Orb     double
                Args.objSlater          (1,1)   QuanFloq.baseFloquet
