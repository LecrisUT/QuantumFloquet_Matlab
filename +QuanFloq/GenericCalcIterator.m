classdef GenericCalcIterator < QuanFloq.baseCalcIterator
    ...
    %
    % See also QuanFloq.baseCalcIterator, function
    ...
    properties (SetAccess=protected)
        ...
        % See also function, QuanFloq.GenericCalcIterator.next
        updatefcn
    end
    methods
        function obj = GenericCalcIterator(object,updatefcn,Args)
            ...
            % QuanFloq.GenericCalcIterator.next

            obj@QuanFloq.baseCalcIterator(object);
