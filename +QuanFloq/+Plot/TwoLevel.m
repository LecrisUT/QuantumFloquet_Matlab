classdef TwoLevel < QuanFloq.QuanFloq.Plot.baseFloquet
    properties (SetAccess=protected)
        colors2     = {'red','blue'}
    end
    methods
        function obj=TwoLevel(calcObj)
            obj@QuanFloq.QuanFloq.Plot.baseFloquet(calcObj);
        end
...
%         end
        ...
        function [fg,ax] = Energy(obj,V_range,Args)
            arguments
                ...
                Args.ymin       = -3
                Args.ymax       =  3
                Args.zooms      (1,:)   QuanFloq.QuanFloq.Plot.rect
                Args.zoomPos    (1,:)   QuanFloq.QuanFloq.Plot.rect
            ...
            if isfield(Args,'zooms')
                if isfield(Args,'zoomPos')
                    ...
                    for iN = 1:length(Args.zooms)
                        ...
                        Args.zoomPos(iN) = QuanFloq.QuanFloq.Plot.rect(x0,y0,...
