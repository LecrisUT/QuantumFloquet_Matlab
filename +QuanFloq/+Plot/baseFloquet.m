classdef baseFloquet < QuanFloq.Plot.basePlot
    methods
        function obj = baseFloquet(calcObj)
            obj@QuanFloq.Plot.basePlot(calcObj);
        end
...
%             ylim(ax,[0 yl(2)]);
        ...
        function [fg,ax] = Energy(obj,V_range,w,Args)
            arguments
                ...
                Args.ymin       = -3
                Args.ymax       =  3
                Args.zooms      (1,:)   QuanFloq.Plot.rect
                Args.zoomPos    (1,:)   QuanFloq.Plot.rect
...
%                         Args.zoomPos(iN) = QuanFloq.Plot.rect(x0,y0,...
