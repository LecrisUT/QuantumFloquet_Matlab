classdef TwoLevel < QuanFloq.baseFloquet
    ...
    methods
        function obj = TwoLevel(Args,Args2)
            ...
            obj@QuanFloq.baseFloquet(2,Args2{:});
            obj.w0 = Args.w0;
            obj.v = Args.v;
    ...
    methods (Access=protected)
        function groups = getPropertyGroups(obj)
            ...
            groups = getPropertyGroups@QuanFloq.baseFloquet(obj);
            if isscalar(obj)
