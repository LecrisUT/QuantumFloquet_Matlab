classdef HarmonicOscillator < QuanFloq.baseFloquet
    ...
    % eigensates. See QuanFloq.Models.HarmonicOscillator.Phinx.
    %
    % See also QuanFloq.Models.HarmonicOscillatorB, QuanFloq.Models.HarmonicOscillatorC,
    % QuanFloq.Models.HarmonicOscillator.Phinx
    ...
    methods
        function obj = HarmonicOscillator(N,Args,Args2)
            ...
            % 
            % See also QuanFloq.Models.HarmonicOscillator, QuanFloq.baseFloquet

            Args2 = namedargs2cell(Args2);
            obj@QuanFloq.baseFloquet(N,Args2{:});
            obj.w0 = Args.w0;
        end
        ...
        function Hx = Hx(obj,x,Args)
            arguments
                obj     QuanFloq.Models.HarmonicOscillator
                x       (:,1)   double
                Args.t  (:,1)   double
            end
...
%             d2x(end,end-1) = 2;
        ...
        function L = intL(obj,t)
            ...
            %   
            % See also QuanFloq.Models.HarmonicOscillator.L
        ...
        function tPsix = Psix(obj,Psi,x,Args,Args2)
            ...
            %   eps - Quasi-energies
            %   
            % See also QuanFloq.baseFloquet.Psit, QuanFloq.Models.HarmonicOscillator.Phinx
