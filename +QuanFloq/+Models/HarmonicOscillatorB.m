classdef HarmonicOscillatorB < QuanFloq.Models.HarmonicOscillator
    ...
    %
    % See also QuanFloq.Models.HarmonicOscillator, QuanFloq.Models.HarmonicOscillatorC
    ...
    methods
        function obj = HarmonicOscillatorB(N,Args2)
            ...
            % 
            % See also QuanFloq.Models.HarmonicOscillator.HarmonicOscillator

            Args2 = namedargs2cell(Args2);
            obj@QuanFloq.Models.HarmonicOscillator(N,Args2{:});
            obj.hk_max = 2;
        end
        function Hy = Hy(obj,y,Args)
            arguments
                obj     QuanFloq.Models.HarmonicOscillatorB
                y       (:,1)   double
                Args.t  (:,1)   double
            end
            % Hy Time-periodic Hamiltonian in shifted position basis
            % See QuanFloq.Models.HarmonicOscillator.Hx
            % 
            % See also See QuanFloq.Models.HarmonicOscillator.Hx
        ...
        function tPsix = Psix(obj,Psi,x,Args,Args2)
            ...
            if ~Args.centerx && isfield(Args,'t')
                ...
                for it = 1:length(Args.t)
                    tt = Args.t(it);
                    tPsix(:,:,it) = Psix@QuanFloq.HarmonicOscillator(obj,...
                ...
                Args2 = namedargs2cell(Args2);
                tPsix = Psix@QuanFloq.HarmonicOscillator(obj,Psi,x,Args2{:});
            end
        end
    end
end