...
del=w-w0;
sigma = [1 0 0];
system = Calc.TwoLevel(w0=w0,w=w,k_max=10,v=0,xi=1E-12,...
...
bath2_0K = Calc.BosonBath2(1,beta=inf);
bath2_10B = Calc.BosonBath2(1,beta=10);
system_bath2_0K = Calc.TwoLevel_Boson(sigma,system=system,bath=bath2_0K);
system_bath2_10B = Calc.TwoLevel_Boson(sigma,system=system,bath=bath2_10B);
fine_tune = [];
...
Details = Calc.Details(script='Calc_TwoLevel3.m',...
