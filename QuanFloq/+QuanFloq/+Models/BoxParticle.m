classdef BoxParticle < QuanFloq.baseFloquet
    ...
    %
    % See also QuanFloq.BoxParticle.Psix
    ...
    methods
        function obj = BoxParticle(N,Args,Args2)
            ...
            % 
            % See also QuanFloq.Models.BoxParticle, QuanFloq.baseFloquet
        ...
        function Psix = Psix(obj,Psi,x,Args,Args2)
            arguments
                obj     QuanFloq.Models.BoxParticle
                Psi     double
                x       (1,1,:) double
                Args.t
                Args.a      (1,1)   double  =1
            ...
            %   eps - Quasi-energies
            %   
            % See also QuanFloq.baseFloquet.Psit
